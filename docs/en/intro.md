...
[![gitcode](https://badgen.net/badge/>>/GitCode/cyan)](https://gitcode.com/vectie)
...
- Send an email to [admin@vectie.com](mailto:admin@vectie.com?Subject=Join%20the%20Vectie%20Open%20Source%20organization) with the GitHub ID to request to join the community.
